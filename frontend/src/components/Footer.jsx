        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="font-bold text-xl">e-Haat Store</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
            Your trusted destination for premium, authenticated products. Shop with confidence — 
            quality and security guaranteed on every purchase.
            </p>
